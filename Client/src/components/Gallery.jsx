...
const Gallery = () => {
  return (
    <section className="min-h-screen px-4 sm:px-6 mt-20 pt-[10vh] py-8 font-poppins bg-gray-100 dark:bg-[#101010] text-gray-900 dark:text-gray-100 transition-colors duration-500">
      <div className="max-w-[90%] md:max-w-[80%] mx-auto">
    
        <div className="flex flex-col items-center mb-8 text-center">
          <div className="w-14 h-14 sm:w-16 sm:h-16 flex items-center justify-center rounded-full bg-lime-100 dark:bg-lime-900 shadow-md mb-5">
            <Camera className="w-7 h-7 sm:w-8 sm:h-8 text-lime-700 dark:text-lime-300" />
          </div>
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-[#2E4600] dark:text-[#FFFC30] tracking-tight">
            Gall
          ...
          <p className="mt-4 max-w-2xl text-gray-700 dark:text-gray-300 text-sm sm:text-base">
          ...
          <div className="w-20 sm:w-24 h-1 bg-lime-500 dark:bg-lime-400 rounded-full mt-6"></div>
        </div>
            ...
            >
              ...
              <div className="md:w-1/2 relative">
                <img
                  src={img.src}
                  alt={img.event}
                  className="w-full h-auto max-h-64 sm:max-h-72 md:max-h-full object-cover"
                />
                <div className="absolute top-3 left-3 bg-lime-600 text-white dark:bg-lime-400 dark:text-gray-900 
                                text-xs sm:text-sm md:text-base px-3 py-1 md:px-4 md:py-2 
                                rounded-tr-lg rounded-bl-lg shadow-lg font-bold">
                  {img.date}
                </div>
              </div>

              
              <div className="md:w-1/2 p-5 sm:p-6 md:p-8 flex flex-col justify-center border-t-4 md:border-t-0 md:border-l-4 border-lime-500 dark:border-lime-400">
                <h3 className="text-lg sm:text-xl md:text-2xl font-extrabold text-gray-900 dark:text-lime-400 mb-3">
                  {img.event}
                </h3>
